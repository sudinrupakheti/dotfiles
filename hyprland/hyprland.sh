...
# Install packages
sudo pacman -S hyprland hyprpaper xdg-desktop-portal-hyprland waybar hyprlock hypridle blueman vlc ntfs-3g tumbler ffmpegthumbnailer file-roller alacritty xdg-user-dirs-gtk neofetch thunar qbittorrent dunst brightnessctl ttf-jetbrains-mono gnome-themes-extra wlsunset grim slurp noto-fonts noto-fonts-emoji noto-fonts-extra ttf-liberation noto-fonts-cjk ttf-dejavu ttf-font-awesome ttf-fira-sans starship adwaita-icon-theme --noconfirm --needed

# Remove unnecessary packages
sudo pacman -R rhythmbox atril mousepad obs-studio --noconfirm --needed

# Install AUR packages (excluding Google Chrome)
yay -S auto-cpufreq nomacs ttf-material-design-icons-desktop-git ttf-meslo-nerd-font-powerlevel10k zen-browser-bin leafpad spotify visual-studio-code-bin wlogout --noconfirm --needed

# Enable CPU frequency scaling tool
...
# Copy configurations to the user's config directory
cd config
